...
const styles: Record<string, React.CSSProperties> = {
  empty: {
    textAlign: "center", color: "var(--text-secondary)", fontSize: "0.9rem", padding: "1.5rem 0.5rem",
  },
  list: {
    listStyle: "none", margin: 0, padding: 0,
    display: "flex", flexDirection: "column", gap: "0.5rem",
  },
  modelItem: { backgroundColor: "var(--bg-surface)", borderRadius: "6px", overflow: "hidden" },
  modelHeader: {
    width: "100%", display: "flex", alignItems: "center", gap: "0.6rem",
    padding: "0.7rem 0.9rem", background: "transparent", border: "none",
    cursor: "pointer", color: "var(--text-primary)", fontSize: "0.9rem", textAlign: "left",
  },
  caret: { color: "var(--text-secondary)", width: "14px" },
  modelName: { flex: 1, fontFamily: "var(--font-mono)" },
  confBadge: { color: "var(--ok)", fontSize: "0.85rem", fontWeight: 600, fontFamily: "var(--font-mono)" },
  fallback: { color: "var(--text-muted)", fontWeight: 400, fontSize: "0.75rem" },
  modelBody: {
    padding: "0 0.9rem 0.9rem",
    display: "flex", flexDirection: "column", gap: "0.7rem",
  },
  confRow: { display: "flex", alignItems: "center", gap: "0.5rem" },
  slider: { flex: 1, accentColor: "var(--ok)", cursor: "pointer" },
  resetBtn: {
    padding: "0.25rem 0.6rem", borderRadius: "4px",
    border: "1px solid var(--hairline-strong)", backgroundColor: "transparent",
    color: "var(--text-secondary)", fontSize: "0.7rem", cursor: "pointer",
  },
  classBox: {
    backgroundColor: "var(--bg-base)", borderRadius: "6px", padding: "0.6rem",
    display: "flex", flexDirection: "column", gap: "0.5rem",
  },
  classHead: { display: "flex", alignItems: "center", gap: "0.4rem", flexWrap: "wrap" },
  classCount: { color: "var(--text-secondary)", fontSize: "0.8rem", flex: 1 },
  smallBtn: {
    padding: "0.2rem 0.5rem", borderRadius: "4px",
    border: "1px solid var(--hairline)", backgroundColor: "transparent",
    color: "var(--text-secondary)", fontSize: "0.7rem", cursor: "pointer",
  },
  search: {
    width: "100%", padding: "0.35rem 0.5rem", borderRadius: "4px",
    border: "1px solid var(--hairline)", backgroundColor: "var(--bg-base)",
  ...
  classRow: {
    ...
    padding: "0.35rem 0.6rem", borderBottom: "1px solid var(--hairline)",
    minHeight: "36px", fontSize: "0.85rem",
  },
  checkbox: {
    width: "16px", height: "16px", accentColor: "var(--ok)", cursor: "pointer",
  },
  colorSwatch: {
  ...
  className: { flex: 1, color: "var(--text-primary)" },
  classId: { color: "var(--text-muted)", fontSize: "0.7rem", fontFamily: "var(--font-mono)" },
  classMsg: {
    padding: "0.6rem", color: "var(--text-secondary)", fontSize: "0.8rem", textAlign: "center",
  },
  classError: { padding: "0.6rem", color: "var(--crit)", fontSize: "0.8rem" },
};
